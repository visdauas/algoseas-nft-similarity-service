import { applyWeightsToAssetDBEntry, applyWeightsToAssetSalesDBEntry } from "../utils";
...
export async function recalculateAssetsWeights(collectionName: string,  statWeights: StatWeights) {
...
export async function recalculateSalesWeights(collectionName: string,  statWeights: StatWeights) {
